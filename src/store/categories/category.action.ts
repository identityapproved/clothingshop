import { ActionWithPayload, Action, createAction, withMatcher } from '../../utils/reducer/actionCreator.utils';
...
export const fetchCategoriesSuccess = withMatcher((categoryArray: Category[]) => createAction(CATEGORIES_ACTION_TYPES.FETCH_CATEGORIES_SUCCESS, categoryArray));
